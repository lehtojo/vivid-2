...
namespace x64 {
	...
	initialize(): _ {
		...
		dual_parameter_encodings[_SAR] = [
			...
			InstructionEncoding(0xD3, 7, ENCODING_ROUTE_M, false, ENCODING_FILTER_TYPE_MEMORY_ADDRESS, 0, 2, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1, instruction_encoder.OPERAND_SIZE_OVERRIDE),
			InstructionEncoding(0xD3, 7, ENCODING_ROUTE_M, false, ENCODING_FILTER_TYPE_MEMORY_ADDRESS, 0, 4, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1),
			InstructionEncoding(0xD3, 7, ENCODING_ROUTE_M, true, ENCODING_FILTER_TYPE_MEMORY_ADDRESS, 0, 8, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1),
		]
		...
		dual_parameter_encodings[_SHR] = [
			...
			InstructionEncoding(0xD3, 5, ENCODING_ROUTE_R, false, ENCODING_FILTER_TYPE_REGISTER, 0, 2, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1, instruction_encoder.OPERAND_SIZE_OVERRIDE),
			InstructionEncoding(0xD3, 5, ENCODING_ROUTE_R, false, ENCODING_FILTER_TYPE_REGISTER, 0, 4, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1),
			InstructionEncoding(0xD3, 5, ENCODING_ROUTE_R, true, ENCODING_FILTER_TYPE_REGISTER, 0, 8, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1),
			...
			InstructionEncoding(0xD3, 5, ENCODING_ROUTE_M, false, ENCODING_FILTER_TYPE_MEMORY_ADDRESS, 0, 2, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1, instruction_encoder.OPERAND_SIZE_OVERRIDE),
			InstructionEncoding(0xD3, 5, ENCODING_ROUTE_M, false, ENCODING_FILTER_TYPE_MEMORY_ADDRESS, 0, 4, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1),
			InstructionEncoding(0xD3, 5, ENCODING_ROUTE_M, true, ENCODING_FILTER_TYPE_MEMORY_ADDRESS, 0, 8, ENCODING_FILTER_TYPE_SPECIFIC_REGISTER, platform.x64.RCX, 1),
		]
